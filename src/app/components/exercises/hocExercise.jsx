...
import withAuth from "../examples/hoc/withLogin";
import withPropsStyle from "../examples/hoc/withPropsStyle";
import SimpleComponent from "../examples/hoc/simpleComponent";

const HocExercise = () => {
    const WithAuth = withAuth(SimpleComponent);
    const WithPropsStyle = withPropsStyle(WithAuth);
    return (
